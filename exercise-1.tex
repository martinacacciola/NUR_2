...
The exercise is done in the script \lstinputlisting{sat.py}. The necessary explanations of the methods used are in the comments of the code.
...
For question (d), we compute the derivative of the function $n(x)$ using both the Ridders' method and the analytical procedure. The obtained results can be seen in: \lstinputlisting{derivative.txt.txt}
