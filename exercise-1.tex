...
For question (a), we do the following: \lstinputlisting[firstline=,lastline=]{satellite.py} The normalization factor A we obtain is the following: \lstinputlisting{normalization.txt}.
